...
import io.algorithms.entity.DataStore;
...
public class AmazonDataStore implements DataStore {
    ...
    /* (non-Javadoc)
     * @see io.algorithms.datastore.DataStore#getOutputStream(java.lang.String, java.lang.String)
     */
    @Override
    public OutputStream getOutputStream(String folder, String fileName) throws IOException {
     ...
     */
    @Override
    public InputStream getInputStream(String folder, String fileName) throws IOException {
        S3Object object;
        try {
